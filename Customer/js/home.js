function fillForm(type) {
  ...
  var driverNeed = document.getElementById("driver-need");

  var returnPlace = document.getElementById("returnPlace");
  var pickPlace = document.getElementById("pickPlace");

  var pickupDate = document.getElementById("pickupDate");
  var returnDate = document.getElementById("returnDate");

  var dlNo = document.getElementById("dlNo");
  var dlExpDate = document.getElementById("dlExpDate");
  ...
  if (type == "fill") {
    if (
      ...
      nic.value == "" ||
      age.value == "" ||
      (driverNeed.checked == false) == "" ||
      dlNo.value == "" ||
      dlExpDate.value == ""
    ) {
      fname.value = "fname";
      lname.value = "lname";
      email.value = "randome@rand.ra";
      nic.value = "200211111111";
      age.value = "18";
      driverNeed.checked = true;
      dlNo.value = "F9287D";
      dlExpDate.value = "2099-01-01";
    }

    if (returnPlace.value == "" || pickPlace.value == "" || true) {
      returnPlace.value = "Head Office";
      pickPlace.value = "Head Office";

      pickupDate.value = "2099-01-01";
      returnDate.value = "2099-01-02";
    }

    cardNumber.value = "2343243223422342";
    exMonth.value = "2099-07";
    cvv.value = "123";
  } else {
    fname.value = "";
    lname.value = "";
